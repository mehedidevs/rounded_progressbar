...
import com.creativeitinstitute.segmentedprogress.R
import com.creativeitinstitute.segmentedprogress.databinding.LayoutRoundedProgressBarBinding
import com.creativeitinstitute.segmentedprogress.roundedprogressbar.ProgressTextOverlay.Companion.DEFAULT_FONT_PATH
import com.creativeitinstitute.segmentedprogress.roundedprogressbar.ProgressTextOverlay.Companion.DEFAULT_SHOW_TEXT
import com.creativeitinstitute.segmentedprogress.roundedprogressbar.ext.setDrawableTint
import com.creativeitinstitute.segmentedprogress.roundedprogressbar.utils.calculateAppropriateCornerRadius
...
class RoundedProgressBar @JvmOverloads constructor(
    ...
    @ColorInt
    private val defaultProgressDrawableColor =
        ContextCompat.getColor(context, R.color.rpb_default_progress_color)
    @ColorInt
    private val defaultBackgroundDrawableColor =
        ContextCompat.getColor(context, R.color.rpb_default_progress_bg_color)
    ...
    @ColorInt
    private var progressDrawableColor: Int = defaultProgressDrawableColor
    @ColorInt
    private var backgroundDrawableColor: Int = defaultBackgroundDrawableColor
    ...
    init {
        ...
        val binding =
            LayoutRoundedProgressBarBinding.inflate(LayoutInflater.from(this.context), this, false)

        progressBar = binding.roundedProgressBar
        progressTextOverlay = binding.progressTextOverlay
        progressBar.max =
    ...
    private fun initAttributes(attrs: AttributeSet?) {
        ...
        val newProgressValue = rpbAttributes.getInteger(
            R.styleable.RoundedProgressBar_rpbProgress,
        ...
        @ColorInt val newProgressDrawableColor = rpbAttributes.getColor(
            R.styleable.RoundedProgressBar_rpbProgressColor,
            defaultProgressDrawableColor
        )
        if (newProgressDrawableColor != defaultProgressDrawableColor) setProgressDrawableColor(
            newProgressDrawableColor
        )

        // Set progress bar background via xml (If exists and isn't the default value)
        @ColorInt val newBackgroundDrawableColor = rpbAttributes.getColor(
            R.styleable.RoundedProgressBar_rpbBackgroundColor,
            defaultBackgroundDrawableColor
        )
        if (newBackgroundDrawableColor != defaultBackgroundDrawableColor) setBackgroundDrawableColor(
            newBackgroundDrawableColor
        )

        // Set text size from xml attributes (If exists and isn't the default value)
        val newTextSize =
            rpbAttributes.getDimension(R.styleable.RoundedProgressBar_rpbTextSize, defaultTextSize)
        ...
        @ColorInt val newProgressTextColor = rpbAttributes.getColor(
            R.styleable.RoundedProgressBar_rpbProgressTextColor,
        ...
        @ColorInt val newBackgroundTextColor = rpbAttributes.getColor(
            R.styleable.RoundedProgressBar_rpbBackgroundTextColor,
        ...
        val newShowProgressText = rpbAttributes.getBoolean(
            R.styleable.RoundedProgressBar_rpbShowProgressText,
        ...
        val newAnimationLength = rpbAttributes.getInteger(
            R.styleable.RoundedProgressBar_rpbAnimationLength,
        ...
        val newIsRadiusRestricted = rpbAttributes.getBoolean(
            R.styleable.RoundedProgressBar_rpbIsRadiusRestricted,
        ...
        val newTextPadding = rpbAttributes.getDimension(
            R.styleable.RoundedProgressBar_rpbTextPadding,
            defaultTextPadding
        )
    ...
    private fun createRoundedProgressDrawable(): Drawable {
        val topLeftRadius =
            calculateAppropriateCornerRadius(cornerRadiusTL, lastReportedHeight, isRadiusRestricted)
        val topRightRadius =
            calculateAppropriateCornerRadius(cornerRadiusTR, lastReportedHeight, isRadiusRestricted)
        val bottomRightRadius =
            calculateAppropriateCornerRadius(cornerRadiusBR, lastReportedHeight, isRadiusRestricted)
        val bottomLeftRadius =
            calculateAppropriateCornerRadius(cornerRadiusBL, lastReportedHeight, isRadiusRestricted)
        ...
        val res =resources.getDrawable(R.drawable.dd)
        return ScaleDrawable(res, Gravity.START, 1f, -1f)
    }
    ...
    internal class SavedState : BaseSavedState {
        ...
        @ColorInt
        var savedProgressDrawableColor: Int = 0
        @ColorInt
        var savedBackgroundDrawableColor: Int = 0
